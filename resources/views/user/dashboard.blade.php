...
<div class="main-panel bg-{{$bg}}">
    <div class="content bg-{{$bg}}">
        <div class="page-inner">
            <div class="mt-2 mb-4">
                <h2 class="text-{{$text}} pb-2">Welcome, {{ Auth::user()->name }}!</h2> <a class="btn btn-primary"
                    href="{{ url('dashboard/deposits') }}"><i class="fas fa-credit-card"></i> Make New deposit</a>
                &nbsp;&nbsp; <a class="btn btn-success" href="{{ url('dashboard/mplans') }}"><i
                        class="fas fa-cubes"></i> Make New Investment</a>
                                ...
                                <div class="col-9 col-stats">
                                    <div class="numbers">
                                        ...
                                        <h4 class="card-title text-{{$text}}">{{$settings->currency}}
                                            {{ number_format($total_bonus->bonus, 2, '.', ',')}}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
