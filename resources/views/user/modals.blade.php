				  ...
				  <div class="modal-content">
					...
					<div class="modal-body bg-{{$bg}}">
						  <form style="padding:3px;" role="form" method="post" action="{{route('newdeposit')}}">
								 <input style="padding:5px;" class="form-control text-{{$text}} bg-{{$bg}}" placeholder="Enter amount here (in USD)" type="text" name="amount" required><br/>
			  ...
			  <div class="modal-content">
				...
				<div class="modal-body bg-dark">
					  <form style="padding:3px;" role="form" method="post" action="{{route('withdrawal')}}">
							 <input style="padding:5px;" class="form-control bg-{{$bg}} text-{{$text}}" placeholder="Enter amount here (in USD)" type="text" name="amount" required><br/>
