...
<head>
    ...
    <title><?php echo $name; ?> | Digital Asset Investment Strategies for Professionals and Beginners. Backed by a team with deep experience in finance. 🚀</title>
            ...
            <div class="menu-cnt">
                <ul id="main-menu">
                        ...
                        <li class="dropdown">
                            ...
                            <a href="#">Services</a>
                            <ul>
                                <li><a href="index-6.php?a=asset">ASSET MANAGEMENT</a></li>
                                <li><a href="index-7.php?a=banking">INVESTMENT BANKING</a></li>
                            </ul>
                            <li class="dropdown">
                            <a href="#">Support</a>
                            <ul>
...
digital asset investing</h1>
                    ...
                    <div class="col-lg-5">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="grid-list gap-18" data-columns="1" data-columns-md="3" data-columns-sm="3" data-columns-xs="1">
                                    <div class="grid-box">
                                        <div class="grid-item">
                                            <div class="" data-anima="fade-right" data-time="3000">
                                                <div>
                                                    <h3></h3>
                                                    <div class="value">
                                                        <span style=" font-size: 25px; line-height: 35px; font-weight: 700; letter-spacing: .5px; color: #03BFCB; "></span>
                                                        <span></span>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div class="container">
                <div class="grid-list" data-columns="3" data-columns-md="1">
                    <div class="grid-box">
                        ...
                        <div class="grid-item">
                            <div class="cnt-box cnt-box-info boxed" data-href="#">
                                ...
                                <div class="caption">
                                    ...
                                    <p>
                                        <?php echo $name; ?> Capital Markets matches human capital with purpose-built infrastructure and systems to help institutional counterparties and private investors meet their unique liquidity needs through a full suite of trading, risk management, and hedging services.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="grid-item">
                            <div class="cnt-box cnt-box-info boxed" data-href="#">
                                <a href="#" class="img-box"><img src="media/E_6.jpg" alt=""></a>
                                <div class="caption">
                                    <h2>Research</h2>
                                    <p>
                ...
                <div class="row row-fit-lg" data-anima="fade-bottom" data-time="1000">
                    <div class="col-lg-6">
                        <ul class="slider light" data-options="arrows:true,nav:false">
                            <li>
                                <a class="img-box img-box-caption lightbox" href="media/image-1.jpg" data-lightbox-anima="fade-top">
                                    <img src="media/image-5.jpg" alt="">
                                    <span>Albert Patterson</span>
                                </a>
                            </li>
                            <li>
                                <a class="img-box img-box-caption lightbox" href="media/image-2.jpg" data-lightbox-anima="fade-top">
                    ...
                    <div class="col-lg-6">
                        <div class="title">
                            ...
                            <p>HOW WE ACHIEVED THIS MISSION</p>
                        </div>
                        <p>
                            At <?php echo $name; ?>, our mission is to expand access to the digital asset ecosystem while serving as trusted partners for our clients.
                        </p>
                        <div class="box-sign">
                            
                            <b>Isaac Hoffman Y. <br> AND <br> Jörg K. Kotenbrink</b>
        ...
        <section class="section-image light" data-parallax="scroll" data-image-src="media/hd-2.jpg">
            <div class="container">
                <div class="row" data-anima="fade-bottom" data-time="1000">
                    <div class="col-lg-6">
                        <div class="title">
                            <h2><?php echo $name; ?> Ranks</h2>
                            <p></p>
                        </div>
                        <p>
Company Ambassadors <br>
200 active direct Downlines and generate $300,000 in sum. A new Ferrari F12berlinetta<br>
Regional Representative Bonus<br>
300 direct Active Downlines generate $500,000 in<br>
all Salary = $2,000<br>
Loan Availability $20,000 Maximum<br>
A gold Rolex watch what of $15,000 and A Ferrari<br>
GTC4lusso<br>
                        </p>
                                ...
                                <div class="grid-item">
                                    <div class="icon-box icon-box-left">
                                        ...
                                        <div class="caption">
                                            ...
                                            <p>Our custom-built APIs provide clients access to more than 10 investment assets*</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="grid-item">
                                    <div class="icon-box icon-box-left">
                                        ...
                                        <div class="caption">
                                            ...
                                            <p>We offer a variety of liquidity provisioning services in secondary markets</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="grid-item">
                                    <div class="icon-box icon-box-left">
                                        ...
                                        <div class="caption">
                                            ...
                                            <p>Our team can tailor execution to meet your requirements in a timely manner</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="grid-item">
                                ...
                                <div class="grid-item">
                                    <div class="icon-box icon-box-left">
                                        ...
                                        <div class="caption">
                                            ...
                                            <p>Our team can work with you to design solutions that are specific to your mandate and requirements</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="panel active">
                        <div class="grid-list" data-columns="4" data-columns-lg="2" data-columns-sm="1">
                            <div class="grid-box">
                             ...
                             <div class="grid-item">
                                    <div class="cnt-box cnt-box-top-icon boxed">
                                        <img src="images/prices-usdt.svg" alt="">
                                        <div class="caption">
                                            <center><h2>Tether Usdt</h2></center>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="container">
                <div class="row align-items-center" data-anima="fade-bottom" data-time="1000">
                    ...
                    <div class="col-lg-6 col-md-6">
                        ...
                        <p>
                            <?php echo $name; ?> is boldly charting a new path in a new frontier of finance, and helping investors of all types achieve their financial goals. The CoinShares Group brings together a wide range of financial products and services into a single brand that our clients can depend on.
                        </p>
