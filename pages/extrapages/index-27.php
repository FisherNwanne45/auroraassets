...
<head>
    ...
    <title>Empic Company Limited | Digital Asset Investment Strategies for Professionals and Beginners. Backed by a team with deep experience in finance. 🚀</title>
            ...
            <div class="menu-cnt">
                <ul id="main-menu">
                            ...
                            <li><a href="index-1.htm?a=home">Home</a></li>
                             <li><a href="index-2.htm?a=nfp">OUR VIDEOS</a></li>
                        <li class="dropdown">
                            <a href="#">Who We Are</a>
                            <ul>
                    ...
                    <div class="col-lg-5">
                        <div class="row">
                            ...
                            <div class="col-lg-8" data-anima="fade-right" data-time="4000">
                                ...
                                <a href="index-13.htm?a=signup" class="btn btn-sm">GET STARTED</a>
                                <a href="index-12.htm?a=login" class="btn btn-sm">LOGIN</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                        ...
                        <div class="grid-item">
                            <div class="cnt-box cnt-box-info boxed" data-href="#">
                                ...
                                <div class="caption">
                                    ...
                                    <p>
                                        Empic Company Limited Capital Markets matches human capital with purpose-built infrastructure and systems to help institutional counterparties and private investors meet their unique liquidity needs through a full suite of trading, risk management, and hedging services.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row row-fit-lg" data-anima="fade-bottom" data-time="1000">
                    ...
                    <div class="col-lg-6">
                        ...
                        <p>
                            At Empic Company Limited, our mission is to expand access to the digital asset ecosystem while serving as trusted partners for our clients.
                        </p>
                        <div class="box-sign">
...
GTC4lusso<br>
        ...
        <section class="section-base section-color">
            ...
            <div class="container">
                <div class="title" data-anima="fade-bottom" data-time="1000">
                    <h2>Face Of Empic Limited Company</h2>
                    <p></p>
                </div>
                <hr class="space-xs">
                <div class="tab-box tab-top-right" data-tab-anima="fade-bottom" data-anima="fade-bottom" data-time="1000">
            ...
            <div class="container">
                <div class="row align-items-center" data-anima="fade-bottom" data-time="1000">
                    ...
                    <div class="col-lg-6 col-md-6">
                        ...
                        <p>
                            Empic Company Limited is boldly charting a new path in a new frontier of finance, and helping investors of all types achieve their financial goals. The CoinShares Group brings together a wide range of financial products and services into a single brand that our clients can depend on.
                        </p>
                        <a href="index-3.htm?a=about" class="btn btn-xs">Learn more</a>
                    </div>
                </div>
                <hr class="space-sm">
