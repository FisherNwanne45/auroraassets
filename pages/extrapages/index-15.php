...
<form method="post" name="forgotform" class="form-box form-ajax" onsubmit="return checkform();"><input type="hidden" name="form_id" value="16946998591569"><input type="hidden" name="form_token" value="9a14ff6e7c12caf87b7e5f280f6c9a2f">
<input type="hidden" name="a" value="forgot_password">
<input type="hidden" name="action" value="forgot_password">
 <div class="row">
                                <div class="col-lg-6">
                                    <p>Your Username Or E-Mail</p>
                                    <input type="text" name='email' value="" class="input-text">
                                </div>
                               
                            </div>

 <button class="btn btn-xs" type="submit">Forgot</button>
