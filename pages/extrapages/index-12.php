...
<br>
<form method="post" name="mainform" class="form-box form-ajax" onsubmit="return checkform()"><input type="hidden" name="form_id" value="16946998491517"><input type="hidden" name="form_token" value="685b0fb267fe568efbdd7e7a240d5bcc">
...
<input type="hidden" name="follow_id" value=''>
 <div class="row">
                            ...
                            <a href="index-15.htm?a=forgot_password">Forgot Password?</a>
                            <br><br>
